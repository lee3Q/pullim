...
- 상태: 진행 중
- 최종 갱신: 2026-03-31
- 2026-03-31: **Vercel 배포 정상화** (30커밋 누락→수동배포+GitHub 연동). UI 긴급 수정 8건: BGM 홈+세션 추가, response-parser HTML태그 제거, 파악 진입 복원(테마별 파악/바로대화 분기), 카드형 뷰(이전/다음+대화형 토글), 사용자 선택 밝기, footer 겹침 제거. **미해결**: 이미지 매핑 경로 불일치.
