...
const GARDEN_SCENES: StoryScene[] = [
  {
    ...
    imagePath: "/assets/discovery/garden_1.png",
    narrative: "정원 안에 들어왔어.\n안개가 살짝 끼어있네.\n\n앞에 두 갈래 길이 보여.\n한쪽은 꽃이 활짝 핀 길,\n다른 쪽은 조용한 돌담 길.\n\n어디로 가고 싶어?",
    choices: [
      { emoji: "🌸", label: "꽃길 — 색이 예쁘다", signals: [{ axis: "risk", value: 1 }] },
      { emoji: "🪨", label: "돌담길 — 고요하다", signals: [{ axis: "risk", value: -1 }], recommended: true },
    ],
  },
  {
    id: "garden_2",
    illustration: "길을 걷다 벤치에 앉아있는 누군가 발견, 등을 보이고 있음",
    imagePath: "/assets/discovery/garden_2.png",
    narrative: "걷다 보니 벤치에\n누군가 앉아있어.\n등을 보이고 있는데,\n어깨가 좀 처져 보여.",
    choices: [
      { emoji: "🤝", label: "옆에 앉는다", signals: [{ axis: "coping", value: 1 }, { axis: "approach", value: 1 }] },
      { emoji: "👀", label: "조용히 지나간다", signals: [{ axis: "coping", value: -1 }, { axis: "approach", value: -1 }], recommended: true },
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/garden_3.png",
    narrative: "옆에 앉았더니\n그 사람이 고개를 돌려.\n\"...고마워요.\"\n\n잠깐 침묵이 흐르고,\n그 사람이 물어.\n\n\"혹시 여기 자주 와요?\"",
    choices: [
      { emoji: "😌", label: "\"처음이에요\"", signals: [{ axis: "approach", value: 1 }] },
      { emoji: "🌙", label: "\"가끔 생각이 많을 때\"", signals: [{ axis: "approach", value: -1 }] },
  ...
  // ─── 이후 보너스 장면 (계속 산책) ───
  {
    ...
    imagePath: "/assets/discovery/garden_5.png",
    narrative: "이야기하는 사이\n빗방울이 떨어지기 시작해.\n\n멀리 정자가 보이고,\n비는 점점 굵어지고 있어.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/garden_8.png",
    narrative: "정원 한쪽에\n물뿌리개가 놓여 있어.\n\n옆에 시든 꽃 몇 송이.\n물을 주면 살아날 것 같기도 하고.",
    choices: [
...
const ADVENTURE_SCENES: StoryScene[] = [
  {
    ...
    imagePath: "/assets/discovery/adventure_1.png",
    narrative: "모험의 숲에 들어섰어.\n두 갈래 길이 보여.\n\n한쪽은 햇빛이 비치는 넓은 길,\n다른 쪽은 어둡지만 새소리가 들리는 좁은 길.",
    choices: [
      { emoji: "☀️", label: "넓은 길 — 밝고 안전해 보인다", signals: [{ axis: "risk", value: -1 }] },
      { emoji: "🌲", label: "좁은 길 — 새소리가 끌린다", signals: [{ axis: "risk", value: 1 }], recommended: true },
    ],
  },
  {
    id: "adventure_2",
    illustration: "숲 속 빈터에 오래된 보물상자, 자물쇠가 걸려 있음",
    imagePath: "/assets/discovery/adventure_2.png",
    narrative: "빈터에 오래된 상자가 있어.\n자물쇠가 걸려 있는데\n옆에 열쇠 같은 게 보여.\n\n그런데 상자가 살짝 움직이는 것 같기도.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_3.png",
    narrative: "길 옆에 누군가 쓰러져 있어.\n발목을 잡고 아파하고 있네.\n\n급해 보이진 않지만\n혼자 일어나긴 힘들어 보여.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_4.png",
    narrative: "갑자기 어둠 속에서 목소리가 들려.\n\n\"여행자여, 소원 하나를 들어주지.\n단, 지금 바로 말해야 해.\"",
    choices: [
      { emoji: "💭", label: "\"잠깐, 생각할 시간을 줘\"", signals: [{ axis: "decision", value: -1 }] },
      { emoji: "⚡", label: "바로 대답한다", signals: [{ axis: "decision", value: 1 }], recommended: true },
  ...
  // ─── 보너스 장면 ───
  {
    ...
    imagePath: "/assets/discovery/adventure_5.png",
    narrative: "절벽 끝에 뭔가 반짝여.\n내려가면 가까이 볼 수 있는데\n밧줄이 좀 낡아 보여.\n\n돌아가면 한참 걸리고.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_6.png",
    narrative: "세 갈래 길.\n이정표가 있는데 글씨가 다 지워졌어.\n\n왼쪽에서 물소리,\n가운데는 조용하고,\n오른쪽은 연기 냄새.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_7.png",
    narrative: "작은 마을에 도착했어.\n여인숙 안에서 웃음소리가 들려.\n\n그런데 뭔가 어색한 기운도 느껴지고.\n피곤하긴 한데.",
    choices: [
      { emoji: "🏠", label: "들어가서 쉰다", signals: [{ axis: "risk", value: 1 }] },
      { emoji: "⛺", label: "마을 밖에서 야영한다", signals: [{ axis: "risk", value: -1 }] },
      { emoji: "🍺", label: "들어가서 정보를 모은다", signals: [{ axis: "approach", value: -1 }], recommended: true },
    ],
  },
  {
    id: "adventure_8",
    illustration: "깊은 동굴, 안쪽에서 푸른 빛이 새어 나옴",
    imagePath: "/assets/discovery/adventure_8.png",
    narrative: "동굴을 발견했어.\n안쪽에서 푸른 빛이 새어 나와.\n\n아름답지만\n뭔지 모르겠어.",
    choices: [
      { emoji: "✨", label: "빛을 향해 들어간다", signals: [{ axis: "risk", value: 1 }] },
      { emoji: "🗣️", label: "소리를 질러본다", signals: [{ axis: "approach", value: 1 }] },
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_9.png",
    narrative: "앞에 넓은 강이 있어.\n물살이 꽤 세 보여.\n\n다리가 있었는데 부서져 있고,\n좀 더 가면 얕은 곳이 있을 수도.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/adventure_10.png",
...
const STRATEGY_SCENES: StoryScene[] = [
  {
    ...
    imagePath: "/assets/discovery/strategy_1.png",
    narrative: "새 프로젝트 브리핑.\n화이트보드에 두 가지 전략이 적혀 있어.\n\nA안은 검증된 방법,\nB안은 새로운 시도.",
    choices: [
      { emoji: "📊", label: "A안 — 검증된 방법으로", signals: [{ axis: "risk", value: -1 }] },
      { emoji: "🚀", label: "B안 — 새로운 시도로", signals: [{ axis: "risk", value: 1 }], recommended: true },
    ],
  },
  {
    id: "strategy_2",
    illustration: "모니터 화면에 숫자가 빼곡한 보고서, 빨간 동그라미",
    imagePath: "/assets/discovery/strategy_2.png",
    narrative: "분석 보고서를 보는데\n숫자가 안 맞는 부분이 있어.\n\n작은 오차인데\n결론에 영향을 줄 수도 있고 아닐 수도.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_3.png",
    narrative: "팀원이 실수로\n중요한 파일을 날렸어.\n\n얼굴이 하얘져 있고\n어떡하지 하는 표정.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_4.png",
    narrative: "회의에서 두 안이 팽팽해.\n결정권이 너한테 있어.\n\n양쪽 다 일리가 있고\n시간은 좀 있어.",
    choices: [
  ...
  // ─── 보너스 장면 ───
  {
    ...
    imagePath: "/assets/discovery/strategy_5.png",
    narrative: "경쟁사가 예상 못한\n제품을 내놨어.\n\n우리 전략이 흔들릴 수도 있고\n그냥 무시해도 될 수준일 수도.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_6.png",
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_7.png",
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_8.png",
    narrative: "상사가 말해.\n\"이번 건은 자유롭게 해봐.\n내가 다 맡길게.\"\n\n텅 빈 화이트보드 앞에 서있어.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_9.png",
    narrative: "오늘 안에 끝내면\n내일이 편해져.\n\n근데 지금 집중력이 좀 떨어지고\n피로가 쌓여있어.",
    choices: [
  ...
  },
  {
    ...
    imagePath: "/assets/discovery/strategy_10.png",
    narrative: "발표 중인데\n누군가 손을 들어.\n\n\"그 접근은 위험하지 않나요?\"\n\n분위기가 살짝 긴장돼.",
    choices: [
...
export const THEME_STORIES: Record<ThemeType, ThemeStory> = {
  garden: {
    ...
    outroImagePath: "/assets/discovery/garden_outro.png",
    minScenes: 4,
  ...
  adventure: {
    ...
    outroImagePath: "/assets/discovery/adventure_outro.png",
    minScenes: 4,
  ...
  strategy: {
    ...
    outroImagePath: "/assets/discovery/strategy_outro.png",
    minScenes: 4,
